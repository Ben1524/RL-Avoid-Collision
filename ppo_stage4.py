...
from model.net4 import CNNPolicy,OriginalCNNPolicy
from stage_world4 import StageWorld
...
if __name__ == '__main__':
    ...
    if rank == 0:
        ...
        # 加载原模型
        old_model = OriginalCNNPolicy(LASER_HIST, ACT_SIZE)
        # 这里可以加载原模型的参数，例如：
        ...
        # 创建新模型
        new_model = CNNPolicy(LASER_HIST, ACT_SIZE)
